...
(function() {
  ...
  if (_STR_exports_STR_ === null) {
    ...
    })(_STR_root_STR_, [ "_STR_fnjs_STR_", "namespaces", "test_MIN_misc" ]);
    _STR_ns_STR_ = _STR_root_STR_._STR_fnjs_STR_.namespaces.test_MIN_misc;
  } else {
    _STR_ns_STR_ = _STR_exports_STR_;
  }
  _STR_ns_STR_.__namespace__ = "test_MIN_misc";
  if (_STR_exports_STR_ === null) {
  ...
  _STR_root_STR_._STR_fnjs_STR_.core.nth = function(x, i) {
    return x[i];
  };
  _STR_root_STR_._STR_fnjs_STR_.core.get = function(x, i) {
    return x[i];
  };
  ...
  console.log(_STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.bind([ 1, 2, 3 ], function(x) {
    return _STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.bind([ "foo", "bar" ], function(y) {
      return _STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.result([ x, y ]);
    });
  }));
  (function() {
    _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.bind([ 1, 2, 3 ], function(x) {
      return _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.bind([ "foo", "bar" ], function(y) {
        return _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.result(function() {
  ...
  console.log(_STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.bind([ 1, 2, 3, 4 ], function(x) {
    return x != 3 ? _STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.bind([ 1, 2, 3, 4 ], function(y) {
      return x >= y ? function() {
        var s = x + y;
        return _STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.bind([ "x", "y" ], function(z) {
          return function() {
            var a = [ x, y, z, s ];
            return _STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.result(a);
          }();
        });
      }() : _STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.exit();
    }) : _STR_root_STR_._STR_fnjs_STR_.core.sequence_MIN_m.zero();
  }));
  (function() {
    _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.bind([ 1, 2, 3, 4 ], function(x) {
      return x != 3 ? _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.bind([ 1, 2, 3, 4 ], function(y) {
        return x >= y ? function() {
          var s = x + y;
          return _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.bind([ "x", "y" ], function(z) {
            return function() {
              var a = [ x, y, z, s ];
              return _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.result(function() {
        ...
        }() : _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.exit();
      }) : _STR_root_STR_._STR_fnjs_STR_.core.doseq_MIN_m.zero();
    });
    return null;
  })();
